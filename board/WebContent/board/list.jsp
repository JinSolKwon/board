...
<table class="listwritebutton">
	<tr>
		<td>
			<a href="${pageContext.request.contextPath}/board/writeForm.do">파일 업로드</a>
		</td>
	</tr>
</table>
<c:if test="${count == 0}">
...
<c:if test="${count > 0}">
	...
	<c:forEach var="1" begin="${startPage}" end="${endPage}">
		<a href="${pageContext.request.contextPath}/board/list.do?pageNum=${1}">[${1}]</a>
	</c:forEach>
